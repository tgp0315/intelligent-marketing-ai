<template>
  <div class="backgroundWhite">
    ...
    >
      ...
      <div style="width: 100%; position: absolute;  left: 0px; background: #fff; padding: 20px 20px 0 20px;">
        <el-table
          ...
          >
            <template #default="scope">
              <el-tag
                ...
                :key="item"
                :style="{color: item===1? '#F53F3F' : item===2? '#00B42A': '#0FC6C2', 'border-color': item===1? '#F53F3F' : item===2? '#00B42A': '#0FC6C2'}"
                effect="plain"
              >
